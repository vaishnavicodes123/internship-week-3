...
const Register = () => {
  ...
  return (
    <>
      <div style={{ position: 'relative', overflow: 'hidden', backgroundColor: '#282c34', color: '#61dafb', fontFamily: 'Arial, sans-serif' }}>
        <Particles
          id="tsparticles"
          init={particlesInit}
            ...
            <h1 className="text-center">
              ...
              <Form>
                ...
                <div style={{width: "100%", display: "flex" , alignItems:"center", justifyContent:"center", flexDirection: "column"}} className="mt-4">
                  ...
                  <p className="mt-3" style={{color: "#61dafb"}}>Already have an account? <Link to="/login" className="lnk">Login</Link></p>
                </div>
              </Form>
            </Col>
          </Row>
